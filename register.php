            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="login-panel panel panel-default">
                    ...
                    <div class="panel-body">
                        <form id="registrationForm" data-toggle="validator" role="form" method="post">
                            <fieldset>
                                ...
                                <input type="submit" class="btn btn-lg btn-default btn-block" value="Register" name="Submitting">
