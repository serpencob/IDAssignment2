                            ...
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
										...
										$sql = "SELECT COUNT(*) FROM personal_data;";
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                    ...
                                    <table class="table table-bordered table-hover table-striped">
                                        ...
                                        <tbody>
                                            <?php
												...
												if (mysqli_num_rows($result) > 0) {
    												while($row = mysqli_fetch_assoc($result)) {
        												echo "<tr><td>".$row["firstname"]."</td><td>".$row["midname"]."</td><td>".$row["lastname"]."</td><td>".$row["gender"]."</td><td>".$row["birthday"]."</td><td>".$row["phone"]."</td><td>".$row["email"]."</td><td>".$row["role"]."</td></tr>";
    												}
												} else {
    												echo "0 results";
												}
                                ...
                                <div class="text-right">
                                    <a href="tables.php">View the whole table<i class="fa fa-arrow-circle-right"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
